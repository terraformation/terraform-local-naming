...
functionality you're adding in your contribution. Check out the [tests](https://github.com/terraformation/terraform-local-naming/tree/master/test) folder for instructions on running the 
automated tests. 
